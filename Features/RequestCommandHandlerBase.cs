...
{
    public class RequestCommandHandlerBase
    {
        protected IUnitOfWorkCommand _unitOfWork { get; private set; }
        protected IHttpContextAccessor _httpContext { get; private set; }
        protected IMapper _mapper { get; private set; }

        public RequestCommandHandlerBase(IUnitOfWorkCommand unitOfWork,
